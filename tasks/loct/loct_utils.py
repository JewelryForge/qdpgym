...
class Actor(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.action_layers(torch.concat((extero_feature, locomotion_feature), dim=-1)).tanh()
    ...
    class Policy(object):
        ...
        def __call__(self, obs):
            ...
            return self.net(obs.reshape(-1, self.input_dim)).detach().cpu().numpy()

    @property
    def policy(self):
        return self.Policy(self, self.input_dim)
